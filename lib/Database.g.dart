    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Item` (`id` INTEGER NOT NULL, `name` TEXT NOT NULL, `count` INTEGER NOT NULL, PRIMARY KEY (`id`))');
...
class _$ShoppingListDao extends ShoppingListDao {
  ...
  @override
  Future<void> deleteItem(Item p) async {
    await _itemDeletionAdapter.delete(p);
  }
}
